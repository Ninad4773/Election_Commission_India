...
public class VoterAddress {
	...
	private AssemblyInfo parliamentInfo;
	@OneToOne
	...
	public AssemblyInfo getParliamentInfo() {
		return parliamentInfo;
	}

	public void setParliamentInfo(AssemblyInfo parliamentInfo) {
	...
	public String toString() {
		return "VoterAddress [addressId=" + addressId + ", state=" + state + ", district=" + district + ", taluka="
				+ taluka + ", village=" + village + ", pincode=" + pincode + ", assemblyInfo=" + assemblyInfo
				+ ", parliamentInfo=" + parliamentInfo + ", voterInfo=" + voterInfo + "]";
	}
